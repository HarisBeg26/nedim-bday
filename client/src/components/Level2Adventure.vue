...
const questions = [
  ...
  { id: 5, text: "Ajde reci mi, koliko je 2 + 2? Da vidim jel si budan uopšte.", type: 'warmup', keywords: ['4', 'četiri'], response: "Dobar si dobar si, vidim da si skoncentrisan. Nemoj mislit da će i ostala pitanja biti laka." },
  ...
  { id: 9, text: "Derivacija sad. d/dx od x na treću?", type: 'math', key: 'simple_derivative', response: "Aa 3x na kvadrat, jasno je ko dan. Pa dobro, to je kao da pitam koliko je sati. Ajde sad nešto što traži bar malo mozga." },
  ...
  { id: 11, text: "Ajde sad, derivacija od e na x kvadrat. Možeš ti to... valjda.", type: 'math', key: 'derivative_exp', response: "Aaaaa e jesi me našo tu sad, jeste, 2x puta e na x kvadrat. Ae dobro, vidim da ti matematika nije strana. Lafac si ti." },
  ...
  { id: 14, text: "Kinematika sada. v nula je 20 m/s, vrijeme 5 sekundi, a je 2 m/s kvadrat. Udaljenost?", type: 'physics', key: 'kinematics', response: "125 metara! Ma jel moguće da znaš i to. Dobro, očekivo sam da znaš, jer smo isti nivo ti i ja. Al opet, rijetko je." },
